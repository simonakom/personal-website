    ...
    return (
        <div className='projects' id="projects">
            <div className='px-9 max-w-3xl mx-auto'>
                <div className={`mb-10 sticky top-0 z-40 py-4 ${isDarkMode ? 'bg-[#0f172a]/95 backdrop-blur-sm' : 'bg-[#ebeef5]/95 backdrop-blur-sm'}`}>
