        ...
        <div className='skills' id="skills">
            <div className='max-w-3xl mx-auto px-10 sm:px-10 md:px-10 lg:px-5'>
                ...
                <div className="gradient-border-left gradient-border-blue pl-6">
                    ...
                    <p className="text-base leading-relaxed" style={{textAlign: 'justify', textAlignLast: 'left', hyphens: 'auto'}}>In fast-paced environments, I quickly grasp new concepts, tools, and technologies, enabling me to adapt and contribute effectively to team objectives. My ability to rapidly acquire knowledge allows me to tackle challenges head-on and drive continuous innovation within projects.</p>
                </div>
                <div className="gradient-border-left gradient-border-blue pl-6">
                    <h3 className="text-base font-semibold mb-3 flex items-center gap-2">
                ...
                <div className="gradient-border-left gradient-border-blue pl-6">
                    ...
                    <p className="text-base leading-relaxed" style={{textAlign: 'justify', textAlignLast: 'left', hyphens: 'auto'}}>I approach challenges with optimism, turning them into opportunities for growth. With a positive mindset, I adeptly solve problems by leveraging creative solutions to overcome obstacles and drive progress within the team.</p>
                </div>
                <div className="gradient-border-left gradient-border-blue pl-6">
                    <h3 className="text-base font-semibold mb-3 flex items-center gap-2">
