            ...
            <div className="mb-16">
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 mx-9'>
                    {[
                        ...
                        { title: <><span className="font-bold">PulpCinemaHub</span> <span className="font-thin">Forum</span></>, image: cinema, liveUrl: "https://github.com/simonakom/forum-app", githubUrl: "https://github.com/simonakom/forum-app", tech: "Node.js, MongoDB, JavaScript and more" },
