...
{/*--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/}
                <div className={`sticky top-[-20px] z-50 ${isDarkMode ? 'bg-[#161616]' : 'bg-[#d3d2d4]'}`}>
                     <p className={`my-10 py-2 text-center border-t-2 border-b-2 font-medium ${isDarkMode ? 'border-[#79afdc3e] text-[#79afdc]' : 'border-[#4646b93f] text-[#4d4db9]'}`}> Landing pages</p>
                </div>
                ...
                <div className='grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-4  gap-10'>
                    <div>
                        ...
                        <div className='mt-2'>
                            <p className={`text-[20px] ${isDarkMode ? 'text-[#79afdc]' : 'text-[#4646b9]'}`}><b>Spotify landing page</b></p>
                            ...
                            <a href="https://github.com/simonakom/spotify-app">
                                <b className={`text-sm px-2 py-1 mt-5 rounded-2xl ${isDarkMode ? 'bg-[#79afdc] text-black' : 'bg-[#4646b9] text-white'}`}>Github</b>
                            </a>
                        </div>
                    </div>
                    <div>
                        ...
                        <div className='mt-2'> 
                            <p className={`text-[20px] ${isDarkMode ? 'text-[#79afdc]' : 'text-[#4646b9]'}`}><b>Netflix landing page</b></p>
                            ...
                            <a href="https://github.com/simonakom/netflix-page">
                                <b className={`text-sm px-2 py-1 rounded-2xl ${isDarkMode ? 'bg-[#79afdc] text-black' : 'bg-[#4646b9] text-white'}`}>Github</b>
                            </a>
                        </div>
                    </div>
                    <div>
                        ...
                        <div className='mt-2'> 
                            <p className={`text-[20px] ${isDarkMode ? 'text-[#79afdc]' : 'text-[#4646b9]'}`}><b>Travlog landing page</b></p>
                            <p className='mb-1'> Build with <b className='font-bold'>javascript</b>, <b className='font-bold'>bootstrap</b>, <b className='font-bold'>css</b>, <b className='font-bold'>html</b></p>
                    ...
                    <div>
                        ...
                        <div className='mt-2'> 
                            <p className={`text-[20px] ${isDarkMode ? 'text-[#79afdc]' : 'text-[#4646b9]'}`}><b>Abstract landing page</b></p>
                            <p className='mb-1'> Build with <b className='font-bold'>javascript</b>, <b className='font-bold'>bootstrap</b>, <b className='font-bold'>css</b>, <b className='font-bold'>html</b></p>
                    ...
                    <div>
                        ...
                        <div className='mt-2'> 
                            <p className={`text-[20px] ${isDarkMode ? 'text-[#79afdc]' : 'text-[#4646b9]'}`}><b>Collab landing page</b></p>
                            <p className='mb-1'> Build with <b className='font-bold'>javascript</b>, <b className='font-bold'>bootstrap</b>, <b className='font-bold'>css</b>, <b className='font-bold'>html</b></p>
                    ...
                    <div>
                        ...
                        <div className='mt-2'> 
                            <p className={`text-[20px] ${isDarkMode ? 'text-[#79afdc]' : 'text-[#4646b9]'}`}><b>Sneaker landing page</b></p>
                    ...
                    <div>
                        ...
                        <div className='mt-2'> 
                            <p className={`text-[20px] ${isDarkMode ? 'text-[#79afdc]' : 'text-[#4646b9]'}`}><b>Christmas shop</b></p>
                            <p className='mb-1'> Build with <b className='font-bold'>javascript</b>, <b className='font-bold'>css</b>, <br /><b className='font-bold'>html</b></p>
...
{/*--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/}
                <div className={`sticky top-[-20px] z-50 ${isDarkMode ? 'bg-[#161616]' : 'bg-[#d3d2d4]'}`}>
                    <p className={`my-10 py-2 text-center border-t-2 border-b-2 font-medium ${isDarkMode ? 'border-[#79afdc3e] text-[#79afdc]' : 'border-[#4646b93f] text-[#4d4db9]'}`}>CRUD applications</p>
                </div>
                <div className='grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-4 gap-10'>
                    <div>
                        ...
                        <div className='mt-2'> 
                            <p className={`text-[20px] ${isDarkMode ? 'text-[#79afdc]' : 'text-[#4646b9]'}`}><b>Kolt</b> scooters</p>
                    ...
                    <div>
                        ...
                        <div className='mt-2'> 
                            <p className={`text-[20px] ${isDarkMode ? 'text-[#79afdc]' : 'text-[#4646b9]'}`}><b>Data-table</b> of products</p>
                            <p className='mb-1'> Build with <b className='font-bold'>javascript</b>, <b className='font-bold'>bootstrap</b>,  <b className='font-bold'>css</b>, <b className='font-bold'>html</b></p>
                    ...
                    <div>
                        ...
                        <div className='mt-2'> 
                            <p className={`text-[20px] ${isDarkMode ? 'text-[#79afdc]' : 'text-[#4646b9]'}`}><b>Data-table</b> of people</p>
                            <p className='mb-1'> Build with <b className='font-bold'>javascript</b>, <b className='font-bold'>bootstrap</b>,  <b className='font-bold'>css</b>, <b className='font-bold'>html</b></p>
...
{/*--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/}
                <div className={`sticky top-[-20px] z-50 ${isDarkMode ? 'bg-[#161616]' : 'bg-[#d3d2d4]'}`}>
                    <p className={`my-10 py-2 text-center border-t-2 border-b-2 font-medium ${isDarkMode ? 'border-[#79afdc3e] text-[#79afdc]' : 'border-[#4646b93f] text-[#4d4db9]'}`}>API applications</p>
                </div>
                <div className='grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-4 gap-10'>
                    <div>
                        ...
                        <div className='mt-2'> 
                            <p className={`text-[20px] ${isDarkMode ? 'text-[#79afdc]' : 'text-[#4646b9]'}`}><b>Coctails</b> receipe app</p>
                            <p className='mb-1'> Build with <b className='font-bold'>javascript</b>, <b className='font-bold'>bootstrap</b>,  <b className='font-bold'>css</b>, <b className='font-bold'>html</b></p>
                    ...
                    <div>
                        ...
                        <div className='mt-2'> 
                            <p className={`text-[20px] ${isDarkMode ? 'text-[#79afdc]' : 'text-[#4646b9]'}`}><b>Dogs</b> photo</p>
                            <p className='mb-1'> Build with <b className='font-bold'>javascript</b>, <b className='font-bold'>bootstrap</b>,  <b className='font-bold'>css</b>, <b className='font-bold'>html</b></p>
                    ...
                    <div>
                        ...
                        <div className='mt-2'> 
                            <p className={`text-[20px] ${isDarkMode ? 'text-[#79afdc]' : 'text-[#4646b9]'}`}><b>Poeple</b> selector</p>
                            <p className='mb-1'> Build with <b className='font-bold'>react vite</b>, <b className='font-bold'>tailwind</b>, <b className='font-bold'>css</b>, <b className='font-bold'>localStorage</b></p>
                    ...
                    <div>
                        ...
                        <div className='mt-2'> 
                            <p className={`text-[20px] ${isDarkMode ? 'text-[#79afdc]' : 'text-[#4646b9]'}`}><b>Jokes</b> by Chuck Norris</p>
                            <p className='mb-1'> Build with <b className='font-bold'>javascript</b>, <b className='font-bold'>css</b>, <br /><b className='font-bold'>html</b></p>
...
{/*--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/}
                <div className={`sticky top-[-20px] z-50 ${isDarkMode ? 'bg-[#161616]' : 'bg-[#d3d2d4]'}`}>
                    <p className={`my-10 py-2 text-center border-t-2 border-b-2 font-medium ${isDarkMode ? 'border-[#79afdc3e] text-[#79afdc]' : 'border-[#4646b93f] text-[#4d4db9]'}`}>JavaScript/React projects</p>
                </div>
                <div className='grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-4 gap-10'>
                    <div>
                        ...
                        <div className='mt-2'> 
                            <p className={`text-[20px] ${isDarkMode ? 'text-[#79afdc]' : 'text-[#4646b9]'}`}><b>Google</b> timer & stopwatch</p>
                    ...
                    <div>
                        ...
                        <div className='mt-2'> 
                            <p className={`text-[20px] ${isDarkMode ? 'text-[#79afdc]' : 'text-[#4646b9]'}`}><b>Birthday</b> countdown</p>
                            <p className='mb-1'> Build with <b className='font-bold'>react vite</b>, <b className='font-bold'>tailwind</b>, <br /><b className='font-bold'>css</b></p>
                    ...
                    <div>
                        ...
                        <div className='mt-2'> 
                            <p className={`text-[20px] ${isDarkMode ? 'text-[#79afdc]' : 'text-[#4646b9]'}`}><b>To-do</b> app</p>
                            <p className='mb-1'> Build with <b className='font-bold'>react vite</b>, <b className='font-bold'>tailwind</b>, <b className='font-bold'>css</b>, <b className='font-bold'>localStorage</b></p>
                    ...
                    <div>
                        ...
                        <div className='mt-2'> 
                            <p className={`text-[20px] ${isDarkMode ? 'text-[#79afdc]' : 'text-[#4646b9]'}`}><b>Color</b> picker</p>
                    ...
                    <div>
                        ...
                        <div className='mt-2'> 
                            <p className={`text-[20px] ${isDarkMode ? 'text-[#79afdc]' : 'text-[#4646b9]'}`}><b>Tip</b> counter</p>
                            <p className='mb-1'> Build with <b className='font-bold'>javascript</b>, <b className='font-bold'>bootstrap</b>,  <b className='font-bold'>css</b>, <b className='font-bold'>html</b></p>
                    ...
                    <div>
                        ...
                        <div className='mt-2'> 
                            <p className={`text-[20px] ${isDarkMode ? 'text-[#79afdc]' : 'text-[#4646b9]'}`}><b>BMI</b> calculator</p>
                            <p className='mb-1'> Build with <b className='font-bold'>javascript</b>, <b className='font-bold'>bootstrap</b>, <b className='font-bold'>css</b>, <b className='font-bold'>html</b></p>
                    ...
                    <div>
                        ...
                        <div className='mt-2'> 
                            <p className={`text-[20px] ${isDarkMode ? 'text-[#79afdc]' : 'text-[#4646b9]'}`}><b>Password</b> generator</p>
                            <p className='mb-1'> Build with <b className='font-bold'>javascript</b>, <b className='font-bold'>bootstrap</b>,  <b className='font-bold'>css</b>, <b className='font-bold'>html</b></p>
                    ...
                    <div>
                        ...
                        <div className='mt-2'> 
                            <p className={`text-[20px] ${isDarkMode ? 'text-[#79afdc]' : 'text-[#4646b9]'}`}><b>Password</b> checker</p>
                            <p className='mb-1'> Build with <b className='font-bold'>javascript</b>, <b className='font-bold'>bootstrap</b>,  <b className='font-bold'>css</b>, <b className='font-bold'>html</b></p>
                    ...
                    <div>
                        ...
                        <div className='mt-2'> 
                            <p className={`text-[20px] ${isDarkMode ? 'text-[#79afdc]' : 'text-[#4646b9]'}`}><b>Guessing</b> game!</p>
                            <p className='mb-1'> Build with <b className='font-bold'>javascript</b>, <b className='font-bold'>bootstrap</b>,  <b className='font-bold'>css</b>, <b className='font-bold'>html</b></p>
                    ...
                    <div>
                        ...
                        <div className='mt-2'> 
                            <p className={`text-[20px] ${isDarkMode ? 'text-[#79afdc]' : 'text-[#4646b9]'}`}><b>Palindrome</b> app</p>
                            <p className='mb-1'> Build with <b className='font-bold'>javascript</b>, <b className='font-bold'>bootstrap</b>,  <b className='font-bold'>css</b>, <b className='font-bold'>html</b></p>
                    ...
                    <div>
                        ...
                        <div className='mt-2'> 
                            <p className={`text-[20px] ${isDarkMode ? 'text-[#79afdc]' : 'text-[#4646b9]'}`}><b>Calculator</b></p>
                            <p className='mb-1'> Build with <b className='font-bold'>javascript</b>, <b className='font-bold'>bootstrap</b>, <b className='font-bold'>css</b>, <b className='font-bold'>html</b></p>
                    ...
                    <div>
                        ...
                        <div className='mt-2'> 
                            <p className={`text-[20px] ${isDarkMode ? 'text-[#79afdc]' : 'text-[#4646b9]'}`}><b>Quiz</b></p>
                            <p className='mb-1'> Build with <b className='font-bold'>javascript</b>, <b className='font-bold'>bootstrap</b>,  <b className='font-bold'>css</b>, <b className='font-bold'>html</b></p>
                    ...
                    <div>
                        ...
                        <div className='mt-2'> 
                            <p className={`text-[20px] ${isDarkMode ? 'text-[#79afdc]' : 'text-[#4646b9]'}`}><b>Vowel</b> counter</p>
...
{/*--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/}
                <div className={`sticky top-[-20px] z-50 ${isDarkMode ? 'bg-[#161616]' : 'bg-[#d3d2d4]'}`}>
                    <p className={`my-10 py-2 text-center border-t-2 border-b-2 font-medium ${isDarkMode ? 'border-[#79afdc3e] text-[#79afdc]' : 'border-[#4646b93f] text-[#4d4db9]'}`}>Fullstack applications</p>
                </div>
                <div className='grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-4 gap-10'>
                    <div>
                        ...
                        <div className='mt-2'> 
                            <p className={`text-[20px] ${isDarkMode ? 'text-[#79afdc]' : 'text-[#4646b9]'}`}><b>Rentify</b> pc rent platform</p>
                    ...
                    <div>
                        ...
                        <div className='mt-2'> 
                            <p className={`text-[20px] ${isDarkMode ? 'text-[#79afdc]' : 'text-[#4646b9]'}`}><b>PulpCinemaHub</b> app</p>
...
{/*--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/}
                <div className={`sticky top-[-20px] z-50 ${isDarkMode ? 'bg-[#161616]' : 'bg-[#d3d2d4]'}`}>
                    <p className={`my-10 py-2 text-center border-t-2 border-b-2 font-medium ${isDarkMode ? 'border-[#79afdc3e] text-[#79afdc]' : 'border-[#4646b93f] text-[#4d4db9]'}`}>CSS Projects</p>
                </div>
                <div className='grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-4 gap-10'>
                    <div>
                        ...
                        <div className='mt-2'> 
                            <p className={`text-[20px] ${isDarkMode ? 'text-[#79afdc]' : 'text-[#4646b9]'}`}><b>Contact form</b></p>
                    ...
                    <div>
                        ...
                        <div className='mt-2'> 
                            <p className={`text-[20px] ${isDarkMode ? 'text-[#79afdc]' : 'text-[#4646b9]'}`}><b>Registration form</b></p>
                            <p className='mb-1'> Build with <b className='font-bold'>html</b>, <b className='font-bold'>css</b></p>
                            <a href="https://github.com/simonakom/contact-form">
                                <b className={`text-sm px-2 py-1 rounded-2xl ${isDarkMode ? 'bg-[#79afdc] text-black' : 'bg-[#4646b9] text-white'}`}>Github</b>
                            </a>
                    ...
                    <div>
                        ...
                        <div className='mt-2'> 
                            <p className={`text-[20px] ${isDarkMode ? 'text-[#79afdc]' : 'text-[#4646b9]'}`}><b>Shopping Cart</b></p>
                    ...
                    <div>
                        ...
                        <div className='mt-2'> 
                            <p className={`text-[20px] ${isDarkMode ? 'text-[#79afdc]' : 'text-[#4646b9]'}`}><b>2048 Game</b></p>
                            <p className='mb-1'> Build with <b className='font-bold'>html</b>, <b className='font-bold'>bootstrap</b>, <b className='font-bold'>css</b></p>
                    ...
                    <div>
                        ...
                        <div className='mt-2'> 
                            <p className={`text-[20px] ${isDarkMode ? 'text-[#79afdc]' : 'text-[#4646b9]'}`}><b>Invoice</b></p>
                            <p className='mb-1'> Build with <b className='font-bold'>html</b>, <b className='font-bold'>css</b></p>
                    ...
                    <div>
                        ...
                        <div className='mt-2'> 
                            <p className={`text-[20px] ${isDarkMode ? 'text-[#79afdc]' : 'text-[#4646b9]'}`}><b>Calendar</b></p>
                            <p className='mb-1'> Build with <b className='font-bold'>html</b>, <b className='font-bold'>css</b></p>
